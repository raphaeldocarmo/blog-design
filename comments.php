...
<div class="comentarios">
    ...
    <?php if ( have_comments() ) : ?>
        ...
        <ul class="comentarios__links">
            <li class="comentarios__links__proximo">
                <?php next_comments_link('Próximo'); ?>
            </li>
            <li class="comentarios__links_anteior">
                <?php previous_comments_link('Anteriores'); ?>
            </li>
        </ul>
    ...
    <div class="comentario__escrever">
            ...
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
                <fieldset>
                    ...
                    <p>
                        ...
                        <a href="<?php echo wp_logout_url(); ?>" title="Sair desta conta">
                            Sair desta conta &raquo;
                        </a>
                    </p>
            ...
            <p class="comentario__escrever__cancelar">
